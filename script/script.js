...
//  }
 ...
 function page(id) {
     ...
     .then(response => response.json())
     .then((e) => {
         let postLayout = document.getElementById('post_layout')
         let singlePost = "";
         ...
         <div class="col-md-8 mt-5 m-auto">
                        <div class="card mb-8" onclick="page()">
                           ...
                           <div class="d-flex justify-content-center mb-3">
                               <a href="index.htm"><button type="submit" class="btn btn-warning" >Home page</button></a>
                           </div>
                        </div>
                    </div>
         `
         postLayout.innerHTML = singlePost
     })
